...
class SimpleDB extends AWSBase {
    ...
    function setConsistentRead($bool){
        $this->consistent_ = $bool;
    }

    function getConsistentRead(){
        return $this->consistent_ ? 'true' : 'false';
    }
    ...
    function getAttributes($itemName, $attrName=false) {
        ...
        $p['DomainName'] = $this->domain;
        $p['ItemName'] = $itemName;
        $p['ConsistentRead'] = $this->getConsistentRead();
